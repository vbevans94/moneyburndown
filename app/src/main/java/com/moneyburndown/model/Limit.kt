...
data class Limit(
    ...
    @ColumnInfo(name = "start") var start: Long = BurndownRepo.startDate().time,
    @ColumnInfo(name = "end") var end: Long = BurndownRepo.startDate().plusDays(BurndownRepo.DEFAULT_DAYS).time,
